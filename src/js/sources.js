...
export default [
  ...
  },
  {
    ...
    type: 'gltfModel',
    path: 'models/character/Character_rabbit.gltf',
  },
  {
    name: 'character_rabbit_gun',
    type: 'gltfModel',
    path: 'models/character/Character_rabbit_Gun.gltf',
  },
  // ===== Enemies =====
  ...
  { name: 'tree_1', type: 'gltfModel', path: 'models/Environment/Tree_1.gltf' },
  { name: 'tree_2', type: 'gltfModel', path: 'models/Environment/Tree_2.gltf' },
  { name: 'tree_3', type: 'gltfModel', path: 'models/Environment/Tree_3.gltf' },
  { name: 'fence_center', type: 'gltfModel', path: 'models/Environment/Fence_Center.gltf' },
  { name: 'fence_corner', type: 'gltfModel', path: 'models/Environment/Fence_Corner.gltf' },
  { name: 'fence_end', type: 'gltfModel', path: 'models/Environment/Fence_End.gltf' },
  { name: 'fence_t', type: 'gltfModel', path: 'models/Environment/Fence_T.gltf' },
  { name: 'cube_grass', type: 'gltfModel', path: 'models/cube/Grass.gltf' },
  { name: 'cube_dirt', type: 'gltfModel', path: 'models/cube/Dirt.gltf' },
  { name: 'cube_stone', type: 'gltfModel', path: 'models/cube/Stone.gltf' },
  { name: 'cube_coal', type: 'gltfModel', path: 'models/cube/Coal.gltf' },
  { name: 'cube_snow', type: 'gltfModel', path: 'models/cube/Snow.gltf' },
  { name: 'cube_ice', type: 'gltfModel', path: 'models/cube/Ice.gltf' },
  { name: 'cube_wood', type: 'gltfModel', path: 'models/cube/Wood.gltf' },
  { name: 'cube_leaves', type: 'gltfModel', path: 'models/cube/Leaves.gltf' },
  { name: 'cube_bricks_yellow', type: 'gltfModel', path: 'models/cube/Bricks_Yellow.gltf' },
  { name: 'cube_bricks_red', type: 'gltfModel', path: 'models/cube/Bricks_Red.gltf' },
  { name: 'cube_bricks_grey', type: 'gltfModel', path: 'models/cube/Bricks_Grey.gltf' },
  { name: 'cube_bricks_dark', type: 'gltfModel', path: 'models/cube/Bricks_Dark.gltf' },
  { name: 'cube_diamond', type: 'gltfModel', path: 'models/cube/Diamond.gltf' },
  { name: 'cube_exclamation', type: 'gltfModel', path: 'models/cube/Exclamation.gltf' },
  { name: 'cube_question_mark', type: 'gltfModel', path: 'models/cube/QuestionMark.gltf' },
  { name: 'cube_wood_planks', type: 'gltfModel', path: 'models/cube/WoodPlanks.gltf' },
  { name: 'cube_block_blank', type: 'gltfModel', path: 'models/cube/Block_Blank.gltf' },
  { name: 'cube_block_square', type: 'gltfModel', path: 'models/cube/Block_Square.gltf' },
  // ===== Animals =====
